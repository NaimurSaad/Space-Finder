...
public class ApartmentInfo extends JFrame implements ActionListener{
	...
	Customers cs;
	Offices os;
	public ApartmentInfo(Customers cs,Apartments as,Offices os,Apartment selectedApartment){
		
		super("Apartment Info");
	...
	myFont2 = new Font("Arial",Font.PLAIN,16);
		title = new JLabel("Apartment Informations");
		...
		name1 = new JLabel(selectedApartment.getName());
		name1.setBounds(500,150,250,25);
		name1.setFont(myFont2);
		panel.add(name1);
		
		
		room1 = new JLabel(selectedApartment.getRoom());
		room1.setBounds(500,200,250,25);
		room1.setFont(myFont2);
		panel.add(room1);
		
		floor1 = new JLabel(selectedApartment.getFloor());
		floor1.setBounds(500,250,250,25);
		floor1.setFont(myFont2);
		panel.add(floor1);
		
		location1 = new JLabel(selectedApartment.getLocation());
		location1.setBounds(500,300,250,25);
		location1.setFont(myFont2);
		panel.add(location1);
		
		price1 = new JLabel(selectedApartment.getPrice());
	...
	public void actionPerformed(ActionEvent ae){
		...
		if(back.getText().equals(command)){
			...
			Payment p = new Payment(cs,as,os,selectedApartment);
			p.setVisible(true);
			this.setVisible(false);
			}
		}
