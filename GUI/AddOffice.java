...
public class AddOffice extends JFrame implements ActionListener{
	...
	public AddOffice(Customers cs,Apartments as,Offices os){
	...
	panel.setLayout(null);
		...
		title = new JLabel("Input Office Details");
	...
	public void actionPerformed(ActionEvent ae){
		...
		if(cancel.getText().equals(command)){
			...
			if(!name.isEmpty() && !room.isEmpty() && !floor.isEmpty() && !location.isEmpty() && !price.isEmpty()){
					...
					Office o = new Office(name,room,floor,location,price);
					os.addOffice(o);
